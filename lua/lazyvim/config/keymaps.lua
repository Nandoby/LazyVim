-- This file is automatically loaded by lazyvim.plugins.init
...
if not Util.has("trouble.nvim") then
  ...
  map("n", "]q", vim.cmd.cprev, { desc = "Next quickfix" })
end
...
map("t", "<c-_>", "<cmd>close<cr>", { remap = true, desc = "which_key_ignore" })
