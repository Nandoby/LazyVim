...
-- lazygit
vim.keymap.set("n", "<leader>gg", function() require("lazyvim.util.init").float_term({ "lazygit" }) end, { desc = "Lazygit (cwd)" })
...
vim.keymap.set("n", "<leader>fT", function() require("lazyvim.util.init").float_term() end, { desc = "Terminal (cwd)" })
vim.keymap.set("t", "<esc><esc>", "<c-\\><c-n>", { desc = "Enter Normal Mode" })

-- windows
vim.keymap.set("n", "<leader>ww", "<C-W>p", { desc = "other-window" })
vim.keymap.set("n", "<leader>wr", "<C-W>c", { desc = "delete-window" })
